...
#define GEOFENCE_CENTER_LAT (-4.325100)
#define GEOFENCE_CENTER_LON (15.322200)
#define GEOFENCE_ENTER_RADIUS_M 500.0F
#define GEOFENCE_EXIT_RADIUS_M 550.0F
#define GEOFENCE_CHECK_INTERVAL_MS 5000UL
#define GEOFENCE_CONFIRM_COUNT 3U
